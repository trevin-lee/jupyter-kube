...
const JupyterLab: React.FC<JupyterLabProps> = ({
  ...
  const openInBrowser = async () => {
    if (jupyterUrl) {
      await window.electronAPI.openExternal(jupyterUrl)
      logger.info('Opened JupyterLab in default browser:', jupyterUrl)
    }
  }
  ...
  return (
    <div className="w-full h-screen flex flex-col">
      ...
      {/* Slim toolbar above the embedded JupyterLab */}
      ...
      {jupyterUrl ? (
        <iframe
          ...
          // Jupyter needs same-origin for its cookies/websockets and scripts to run.
